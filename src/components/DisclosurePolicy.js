  ...
  return (
    ...
    <Container maxWidth="md" sx={{ py: 6, mt: 6 }}>
      ...
      <Typography variant="body1">
        At betaFounder, we're committed to maintaining the highest standards of security for our users. We welcome security researchers to report any potential vulnerabilities they discover, provided it’s done in a respectful, ethical, and responsible manner.
      </Typography>
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Typography variant="body2">
          When you report a vulnerability in good faith, betaFounder commits to:
        </Typography>
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <ul style={{ paddingLeft: '1.5rem' }}>
          ...
          <li><Typography variant="body2">Do not test third-party systems integrated with betaFounder</Typography></li>
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Typography variant="body2">
          betaFounder will not pursue legal action against those who identify and report security issues in good faith and within the boundaries of this policy. We reserve all legal rights if these boundaries are not respected.
        </Typography>
      </Box>
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Typography variant="body2">
          Please note that any reward is at our sole discretion and not guaranteed. Rewards will be issued through the channels defined by betaFounder.
        </Typography>
      </Box>
    </Container>
    <Footer />
