...
const TrustCenter = () => {
  ...
  const sections = [
    ...
    },
    {
      title: 'Privacy',
      bulletPoints: [
        'We collect only the data necessary to operate and improve betaFounder.',
...
<Helmet>
  <title>Trust Center | Security, Privacy & Accessibility | betaFounder</title>
  <meta
    name="description"
    content="The betaFounder Trust Center explains how we keep your data safe with encryption, role-based access, GDPR compliance, and accessibility-first design."
  />

  {/* Canonical URL */}
  <link rel="canonical" href="https://www.betaFounder.com/trust-center" />

  {/* Open Graph */}
  <meta property="og:title" content="Trust Center | Security, Privacy & Accessibility | betaFounder" />
  <meta
    property="og:description"
    content="Learn how betaFounder builds trust: AES-256 encryption, GDPR compliance, OAuth 2.0 authentication, WCAG 2.1 accessibility, and transparency by design."
  />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://www.betaFounder.com/trust-center" />
  <meta
    property="og:image"
    content="https://storage.googleapis.com/betaFounderbucketcom/logo_512x512-removebg-preview.png"
  />

  {/* Twitter */}
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Trust Center | Security, Privacy & Accessibility | betaFounder" />
  <meta
    name="twitter:description"
    content="Explore betaFounder's Trust Center — enterprise-grade security, data privacy, GDPR compliance, and accessibility for every user."
  />
  <meta
    name="twitter:image"
    content="https://storage.googleapis.com/betaFounderbucketcom/logo_512x512-removebg-preview.png"
  />
      ...
      <Box sx={{ padding: isMobile ? 2 : 4, mt: 10, px: isMobile ? 2 : 10 }}>
        ...
        <Typography sx={{ fontSize: isMobile ? '18px' : '30px', fontWeight: 400 }} gutterBottom>
          Building trust with our users starts with transparency. The betaFounder Trust Center offers clear, in-depth insights into our approach to security, privacy, accessibility, and compliance.
        </Typography>
